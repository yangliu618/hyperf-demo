...
class TblOrderList extends Model
{
     ...
     * @var array
     */
    protected $casts = ['user_id' => 'integer', 'betAmount' => 'integer', 'validBetAmount' => 'integer', 'return_rebate' => 'integer', 'rebateAmount' => 'integer', 'winAmount' => 'integer', 'netWinAmount' => 'integer', 'multiple' => 'integer', 'chase' => 'integer', 'orderStatus' => 'integer', 'productType' => 'integer', 'pv_id' => 'integer', 'venderId' => 'integer', 'flow_status' => 'integer'];
}
