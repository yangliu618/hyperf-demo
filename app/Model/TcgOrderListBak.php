 ...
 */
class TcgOrderListBak extends Model
{
    /**
     ...
     * @var string
     */
    protected $table = 'tcg_order_list_bak';
     ...
     * @var array
     */
    protected $casts = ['user_id' => 'integer', 'betAmount' => 'integer', 'validBetAmount' => 'integer', 'rebateAmount' => 'integer', 'winAmount' => 'integer', 'netWinAmount' => 'integer', 'multiple' => 'integer', 'chase' => 'integer', 'orderStatus' => 'integer', 'productType' => 'integer', 'pv_id' => 'integer', 'venderId' => 'integer', 'flow_status' => 'integer'];
}
